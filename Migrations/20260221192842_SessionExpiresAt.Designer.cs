...
namespace SystemBase.Migrations
{
    ...
    [Migration("20260221192842_SessionExpiresAt")]
    partial class SessionExpiresAt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SystemBase.Models.users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            name = "Jhonatan",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$akKLs7tI7KEJBVdyCnQuPQ$AngY0fmU55hp5gRNcOmYu7zLnTT3n13uYknNB5MUbmY",
                            userName = "@adminDev"
                        });
                });
