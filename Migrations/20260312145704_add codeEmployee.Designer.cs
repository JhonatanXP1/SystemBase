...
namespace SystemBase.Migrations
{
    ...
    [Migration("20260312145704_add codeEmployee")]
    partial class addcodeEmployee
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SystemBase.Models.users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Jhonatan",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$IsgDx+I0WTmuXHlareHjsw$bbTQKBpZa1vv6rR3D5MYQApgyVvqX0P2aa8Dj7KgMYY",
                            userName = "@adminDev"
                        });
                });
