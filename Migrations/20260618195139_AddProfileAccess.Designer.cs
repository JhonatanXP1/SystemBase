...
namespace SystemBase.Migrations
{
    ...
    [Migration("20260618195139_AddProfileAccess")]
    partial class AddProfileAccess
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SystemBase.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Jhonatan",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$lMDcgm+eUiZUh7yXUSnitQ$Zz6aI2LmG5ImR4BMBnyYU8EcB7IYK9ixxN9zopTN0yI",
                            userName = "@adminDev"
                        });
                });
