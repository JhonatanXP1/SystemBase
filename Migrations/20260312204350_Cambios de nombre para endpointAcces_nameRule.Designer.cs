...
namespace SystemBase.Migrations
{
    ...
    [Migration("20260312204350_Cambios de nombre para endpointAcces_nameRule")]
    partial class CambiosdenombreparaendpointAcces_nameRule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SystemBase.Models.EndpointAccessNameRule", b =>
                {
                    ...
                    b.ToTable("EndpointAccessNameRule");
            ...
            modelBuilder.Entity("SystemBase.Models.users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Jhonatan",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$Sm+NKFz4fZcsgD8PKWl3qA$IrWL6E+1OvU91Lb7//rEVD8z1iIY5mZShJ9mhoaMxzA",
                            userName = "@adminDev"
                        });
                });
