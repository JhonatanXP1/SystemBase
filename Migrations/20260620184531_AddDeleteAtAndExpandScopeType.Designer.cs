...
namespace SystemBase.Migrations
{
    ...
    [Migration("20260620184531_AddDeleteAtAndExpandScopeType")]
    partial class AddDeleteAtAndExpandScopeType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SystemBase.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Jhonatan",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$PhJOxxRpBwnWJy9fc32tnw$vgnGvHyId5CNzFBxRBWMOsAGXIGofr1sWxoLzabwxCM",
                            userName = "@adminDev"
                        });
                });
