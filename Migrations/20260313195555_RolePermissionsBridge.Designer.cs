...
namespace SystemBase.Migrations
{
    ...
    [Migration("20260313195555_RolePermissionsBridge")]
    partial class RolePermissionsBridge
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SystemBase.Models.users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Jhonatan",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$hd1fjpBnMXRBxS9KBcgwFg$QTTiZlJkcuPJurB/Vn8tTid4Ekl0CykTDvseKCG5MXY",
                            userName = "@adminDev"
                        });
                });
