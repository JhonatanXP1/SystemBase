...
namespace SystemBase.Migrations
{
    ...
    [Migration("20260317004910_changes table endpointAccess")]
    partial class changestableendpointAccess
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SystemBase.Models.users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Jhonatan",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$kPJEMypos5OIqbP4EPCVug$oJ9vorLoukSumBSTLRZmIrmU5aeJNN6IzPmSL+34QGM",
                            userName = "@adminDev"
                        });
                });
