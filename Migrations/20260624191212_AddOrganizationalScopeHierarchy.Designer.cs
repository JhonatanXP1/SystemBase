...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SystemBase.Models.CompanyAreaWorkShiftTeam", b =>
                {
                    ...
                    b.Property<int>("idCompanyAreaWorkShift")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SystemBase.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Lois",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$CAR+txuqFNiwKr9VEdCqTg$SHvtLgfOHeNxPrM80sFeiL4gvdwBDaGjvZzgMFgzA+0",
                            userName = "@lois"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Hal",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$mGcm1qi+AtLG7wBVnBLncg$A1U3cdl8bFD7nzUpBYCMCoVz3RG/e7u/nG1XXOU2DNM",
                            userName = "@hal"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Francis",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$bRnZXoLxRcukTk5U1CNaxw$HsYmXg0UYCZ3vN53L2zJd1gqXSVvb0v5zAuR2y+7M3Y",
                            userName = "@francis"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Craig",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$Ss4CAu/0mNp2DZzih86LXg$fsiE6rSZ+6XeiQa5XFYJQSmzKANu30I6Au+O1HuqVtI",
                            userName = "@craig"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Malcolm",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$DGKPVOOJT7fVPgyhiEUSOA$4jfJyVon7Kju8uvjp1uqbPsFmZoqCd7CjpdUVxeAIGo",
                            userName = "@malcolm"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Stevie",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$8jxrXT5bnSUhSloXDj05Bw$a9LMr6RER1VsJ6paF8bzLdoXnNMKgfdJ7Z/xNFm05kI",
                            userName = "@stevie"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Reese",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$95ko7xzizfvDxKL7W+Sr/g$3jlXzq46S8Rja62BSeYIXM22O5SK//aKHxA5dp5Kylw",
                            userName = "@reese"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Dewey",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$lJCf8QEY6h8B/XLygN87vA$Jn/nPLvMfq/He1dMGI7ec8xhXpxYPfwoiVrRDJlh0GY",
                            userName = "@dewey"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Lloyd",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$dMo3ldN0SMTH7Gs9FPmNtQ$IebcHM+YslxCNyYrcTFajqzVCiRjRPLMJtQC4yyUyzg",
                            userName = "@lloyd"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Dabney",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$nOZgZcB1EGJ9bjf7PJLZZA$E5WDtA5mpFwO1r4xoOv+DavICl97MPre9Qcrarm18w0",
                            userName = "@dabney"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Kevin",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$uOuUne3BlJGHuFPjN2qvMA$MrXsB2nK+uSXS7mPyEC4voCPQj40DEHT3sudN070Lgc",
                            userName = "@kevin"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Cynthia",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$Bb2o6s3iCXtiS5HZn09xzA$7eNQaLpqVas5e2Yq/D0OrVe+fZGZbUCyPUBvY1VPRc8",
                            userName = "@cynthia"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "David",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$yMa9+jPUb/WeuGY5I7cKOg$A9YTMyKCfFfxu5O8r8i0ddG/5ahCfE4E+qAkyGeD5iI",
                            userName = "@davidh"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Chad",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$1UGWF2KZGvuZcRWG/IhzNw$L28d1OV+BBbGmn+vQS9S+KKFDs8acMYJpCDVSrLbKH8",
                            userName = "@chad"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Davey",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$5Uxy2ZVCAa+QmJCKarMMUw$dBKsEi7d0b7uhyifc2AdEm9EsQeL47LouYBwJFZoMfQ",
                            userName = "@davey"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Zoe",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$VOpZHIXftgCV1ynuFWq8uQ$wwyBce8MY7qgOv61rhjoVXXXAxFB1EOVS/NvH4SFnIM",
                            userName = "@zoe"
                        },
                        new
                        {
                            ...
                            created = new DateTimeOffset(new DateTime(2026, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            name = "Penelope",
                            password = "$argon2id$v=19$m=32768,t=3,p=2$cnMTRtru/ggdGuqJ4vCuig$WoSTO2ewQDXKN33t0MgmED7xVnnQv59ZHq5YGL3nKCk",
                            userName = "@penelope"
                        });
                });
            ...
            modelBuilder.Entity("SystemBase.Models.CompanyAreaWorkShift", b =>
                {
                    b.HasOne("SystemBase.Models.CompanyArea", "companyArea")
                        .WithMany()
                        .HasForeignKey("idCompanyArea")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SystemBase.Models.CompanyAreaWorkShiftTeam", b =>
                {
                    b.HasOne("SystemBase.Models.CompanyAreaWorkShift", "companyAreaWorkShift")
                        .WithMany()
                        .HasForeignKey("idCompanyAreaWorkShift")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("companyAreaWorkShift");
